...
;# Includes edits SMW's sprites
        ...
        incsrc "../dss/original_sprites/creating_eating_block.asm"
        incsrc "../dss/original_sprites/turn_block_bridge.asm"
        incsrc "../dss/original_sprites/light_switch.asm"
        incsrc "../dss/original_sprites/flying_question_block.asm"
        incsrc "../dss/original_sprites/flying_platform.asm"
