...
!RBBBSXS		= $10	;right x speed of the Bowser Bowling Ball/Big Steely
!LBBBSXS		= $F0	;left x speed of the Bowser Bowling Ball/Big Steely
...
!SG			= $20	;timer used to shake the ground.
