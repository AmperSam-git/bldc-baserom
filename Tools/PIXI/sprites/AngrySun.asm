...
!Clus_SparkleNum = $10		; cluster sprite number (as how it displays in list.txt) for the sparkle that drops off of the Happy Moon
...
!GFX_FileNum = $7E		;EXGFX number for SMB3 Sun
!GFX_FileNum2 = $7F		;EXGFX number for SMM2 Sun
!GFX_FileNum3 = $80		;EXGFX number for Moon
...
!0303	= $0303|!Base2
.subgfx
	LDA !7FAB10,x			;if extra bit set, draw moon
	AND #$04
	BEQ +
...
+
	lda !extra_prop_2,x		;if bit 1 of extra prop 2 set, draw SMM2 sun
	AND #$01
	BEQ .SMB3Sun
	lda #!GFX_FileNum2
	BRA .Queue
...
.SMB3Sun
	lda #!GFX_FileNum     	;else draw SMB3 sun
...
;00 = Top, small blaze
;01 = Bottom, small blaze
;02 = Top, full blaze
;03 = bottom, full blaze

.tilemap
	db $00,$FC,$01,$FC,$FF	; SMB3
	db $02,$FC,$03,$FC,$FF

	db $00,$FC,$FD,$FE,$04	; SMM2; idle
	db $01,$FC,$FD,$FE,$04
	db $02,$FC,$FD,$FE,$04

	db $00,$FC,$FD,$FE,$03	; SMM2; angry
	db $01,$FC,$FD,$FE,$03
	db $02,$FC,$FD,$FE,$03

	db $01,$03,$02,$FF,$FF	; Happy Moon, normal/blinking
	db $00,$03,$02,$FF,$FF

	db $01,$03,$02,$FF,$FF	; Happy Moon, diving
	db $04,$06,$05,$FF,$FF
