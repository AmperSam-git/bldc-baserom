...
!PlaySound = 1	;Sound when triggered (coin)
!SFX 	   = #$01
!SFXBank   = $1DFC|!Base2
...
!SpawnCoin = 1  ;Spawn the coin effect like hitting a kaizo

!Dir    = 1		;Direction to fall - 0 = down, 1 = left, 2 = up, 3 = right
