...
!GFX_FileNum = $8A		;EXGFX number for this sprite
!GFX_FileNum2 = $8B		;EXGFX number for custom gfx variant
...
!RotoDiscTile = $00						; \ If using vanilla cfg you can remap your tile here
...
SUB_GFX:
	...
	LDA !extra_prop_1,x		; \ Find out which cfg is used
	AND #$02				; | By finding out if Bit Set
	BEQ .CustomGFX			; |	If not go check extra bytes
