...
2ad	0	Small door which you can only enter if you carry a key.
...
2b3	0	This block will teleport the player if they are carrying a key
2b4	0	Turns off water level flag and sprite buoyancy when touched.
2b5	0	Turns on water level flag and sprite buoyancy when touched.
...
370	0	conveyer move left fast
371	0	conveyer move left fast
372	0	conveyer move left fast
...
3a3	0	stack/StackBlockSpawn_Right.asm
3a4	0	A Donut Lift, which will fall left shortly after being stepped on.
